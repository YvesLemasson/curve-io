// FASE 2: Spatial Hash para optimización de colisiones
// Divide el canvas en celdas y solo verifica colisiones en celdas cercanas
...
export class SpatialHash {
   ...
   */
  addTrail(playerId: string, trail: Position[]): void {
