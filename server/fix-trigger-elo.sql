-- ============================================
-- Script para asegurar que el trigger de ELO funciona correctamente
-- ============================================
-- Ejecutar en el SQL Editor de Supabase si el trigger no está funcionando

-- 1. Asegurar que la función existe y está correcta
